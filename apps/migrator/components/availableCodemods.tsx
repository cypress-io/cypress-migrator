...
const tableComponent = {
  ...
  tbody: ({ ...props }) => <tbody className="bg-white divide-y divide-gray-400" {...props} />,
  td: ({ children }) => (
...
const AvailableCodemods = ({ allCodeMods }: { allCodeMods: string[] }): ReactElement => {
  ...
  return (
    <>
      <h2 className="text-3xl font-bold text-gray-900 mb-4 capitalize">{selectedLanguage} Migrations</h2>
