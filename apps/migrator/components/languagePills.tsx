  ...
  return (
    <div className="grid md:grid-cols-3 gap-4 sm:grid-cols-1">
      <div className="md:col-start-2 flex justify-center">
        ...
        <ArrowRightIcon className="h-5 w-5 mx-4 my-2 text-gray-600" />
        <span className="px-3 py-2 rounded-full text-sm font-medium bg-jade-300 text-jade-800">Cypress</span>
      </div>
    </div>
  )
}
